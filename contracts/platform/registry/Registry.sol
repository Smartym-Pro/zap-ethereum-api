...
contract Registry is Destructible, RegistryInterface, Upgradable {
        ...
        returns (bool)
    {
        ...
        db.setBytes32(keccak256(abi.encodePacked('oracles', msg.sender, endpoint, 'broker')), bytes20(broker));
    ...
    function getEndpointBroker(address oracleAddress, bytes32 endpoint) public view returns (address) {
        return address(bytes20(db.getBytes32(keccak256(abi.encodePacked('oracles', oracleAddress, endpoint, 'broker')))));
    }
